...
let ourApp = http.createServer(function (req, res) {
  if (req.url == "/") {
    //If requested URL = "homepage", load this msg
    res.end("Hello, and welcome to our homepage.");
  }
  if (req.url == "/about") {
    //If requested URL = "/about", load this msg
    res.end("Thank you for the interest in our company.");
  } else {
    //If URL = "random", load this msg
    res.end("ERROR 404");
  }
});
...
//In the next lesson, we will learn how to work with user submitted data, by collecting, validating and responsing to inputs.
